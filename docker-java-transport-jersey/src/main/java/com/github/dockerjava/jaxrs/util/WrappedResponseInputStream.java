...
/**
 * This is a wrapper around Response that acts as a InputStream. When this WrappedResponseInputStream is closed it
 * closes the underlying Response object also to prevent blocking/hanging connections.
 *
 * @author Marcus Linke
 */
@Deprecated
